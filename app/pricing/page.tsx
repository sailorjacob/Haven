...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3">Request</h3>
              <p className="text-muted-foreground">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-background border border-border p-4 rounded-lg text-center hover:border-primary/50 transition-colors"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">Design board</h3>
              <p className="text-muted-foreground">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">Fixed monthly rate</h3>
              <p className="text-muted-foreground">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">Top-notch quality</h3>
              <p className="text-muted-foreground">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-2">Unique and all yours</h3>
              <p className="text-muted-foreground">
      ...
      {/* Pricing Section */}
      <section ref={featuresRef} className="py-24 px-6" id="pricing">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="bg-background border-2 border-primary rounded-xl overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-secondary rounded-xl p-6 border border-border flex items-center">
                <div className="mr-4">
                  <Clock className="h-8 w-8 text-primary" />
                </div>
                <div>
                  <h4 className="font-medium mb-1">Pause anytime</h4>
              ...
              <div className="bg-secondary rounded-xl p-6 border border-border flex items-center">
                ...
                <div>
                  <h4 className="font-medium mb-1">Try it for a week</h4>
                  <p className="text-sm text-muted-foreground">
      ...
      <section className="py-24 bg-secondary/50 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="font-medium text-lg mb-2">How fast will I receive my designs?</h3>
              <p className="text-muted-foreground">
            ...
            <motion.div
              ...
              className="bg-background border border-border rounded-lg p-6"
            >
              <h3 className="font-medium text-lg mb-2">How does onboarding work?</h3>
              <p className="text-muted-foreground">
            ...
            <motion.div
              ...
              className="bg-background border border-border rounded-lg p-6"
            >
              <h3 className="font-medium text-lg mb-2">Is there a limit to how many requests I can make?</h3>
              <p className="text-muted-foreground">
            ...
            <motion.div
              ...
              className="bg-background border border-border rounded-lg p-6"
            >
              <h3 className="font-medium text-lg mb-2">How does the pause feature work?</h3>
              <p className="text-muted-foreground">
