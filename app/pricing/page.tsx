  ...
  return (
    <main className="bg-white w-full text-zinc-900">
      ...
      <div className="fixed inset-0 z-0">
        ...
        >
          <path d="M16 2c.5 0 .99.03 1.47.09l.43-1.92a1 1 0 0 1 1.22-.75l1.5.35a1 1 0 0 1 .75 1.22l-.43 1.92a13 13 0 0 1 3.34 1.94l1.54-1.54a1 1 0 0 1 1.41 0l1.06 1.06a1 1 0 0 1 0 1.41l-1.54 1.54A13 13 0 0 1 29.24 14l1.92-.43a1 1 0 0 1 1.22.75l.35 1.5a1 1 0 0 1-.75 1.22l-1.92.43c.06.48.09.97.09 1.47s-.03.99-.09 1.47l1.92.43a1 1 0 0 1 .75 1.22l-.35 1.5a1 1 0 0 1-1.22.75l-1.92-.43a13 13 0 0 1-1.94 3.34l1.54 1.54a1 1 0 0 1 0 1.41l-1.06 1.06a1 1 0 0 1-1.41 0l-1.54-1.54A13 13 0 0 1 18 29.24l.43 1.92a1 1 0 0 1-.75 1.22l-1.5.35a1 1 0 0 1-1.22-.75l-.43-1.92a13 13 0 0 1-3.34-1.94l-1.54 1.54a1 1 0 0 1-1.41 0l-1.06-1.06a1 1 0 0 1 0-1.41l1.54-1.54A13 13 0 0 1 2.76 18l-1.92.43a1 1 0 0 1-1.22-.75l-.35-1.5a1 1 0 0 1 .75-1.22l1.92-.43A13 13 0 0 1 2 16c0-.5.03-.99.09-1.47l-1.92-.43a1 1 0 0 1-.75-1.22l.35-1.5a1 1 0 0 1 1.22-.75l1.92.43a13 13 0 0 1 1.94-3.34L4.31 6.9a1 1 0 0 1 0-1.41l1.06-1.06a1 1 0 0 1 1.41 0l1.54 1.54A13 13 0 0 1 14 2.76l.43-1.92A1 1 0 0 1 16 0v2Zm0 6a8 8 0 1 0 0 16 8 8 0 0 0 0-16Z" fill="none" stroke="currentColor" strokeWidth="0.6" />
        </motion.svg>
      </div>
