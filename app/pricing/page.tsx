  ...
  return (
    <main className="bg-white w-full text-zinc-900">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <motion.svg
          viewBox="0 0 32 32"
          className="pointer-events-none absolute -top-40 -left-40 w-[500px] h-[500px] text-zinc-300/50"
          initial={{ rotate: 0 }}
          animate={{ rotate: 360 }}
        ...
        >
          ...
          <circle cx="16" cy="16" r="12" fill="none" stroke="currentColor" strokeWidth="0.2" strokeDasharray="2 3" />
        </motion.svg>
      </div>
