      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-4 pb-20">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-zinc-400">
            ...
            <span className="text-zinc-400">•</span>
            <a href="https://ammocat3000.com" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-zinc-100 transition-colors">
              Visit Website
            </a>
          </div>
        </motion.div>
            ...
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-zinc-300">Ammo Cat</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Website, E-commerce, Game Development</p>
                </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              <h3 className="text-lg mb-4 text-zinc-100">Advanced Search & Filtering</h3>
              <p className="text-zinc-400">
            ...
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              <h3 className="text-lg mb-4 text-zinc-100">Interactive Mini-Game</h3>
              <p className="text-zinc-400">
            ...
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              <h3 className="text-lg mb-4 text-zinc-100">Seamless E-commerce</h3>
              <p className="text-zinc-400">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <h3 className="text-xl text-zinc-100 mb-2">Creative Direction</h3>
              <p className="text-zinc-400">
            ...
            <div>
              ...
              <h3 className="text-xl text-zinc-100 mb-2">UX/UI Design</h3>
              <p className="text-zinc-400">
            ...
            <div>
              ...
              <h3 className="text-xl text-zinc-100 mb-2">Full-stack Development</h3>
              <p className="text-zinc-400">
            ...
            <div>
              ...
              <h3 className="text-xl text-zinc-100 mb-2">Game Development</h3>
              <p className="text-zinc-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">186%</div>
                <p className="text-zinc-400 text-sm">Increase in online sales</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">12min</div>
                <p className="text-zinc-400 text-sm">Average session duration</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">58%</div>
                <p className="text-zinc-400 text-sm">Return visitor rate</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">4.2x</div>
                <p className="text-zinc-400 text-sm">Social media engagement</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="text-center mt-24">
          ...
          <Link href="/moonlight-garden" className="text-xl text-zinc-300 hover:text-zinc-100 transition-colors">
            Moonlight Garden
