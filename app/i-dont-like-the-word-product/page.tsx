...
export default function IDontLikeTheWordProductPage() {
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
          ...
          <div className="mx-auto bg-[#fafaf5] border border-zinc-300 rounded-md shadow-[0_1px_0_rgba(0,0,0,0.05)]">
            ...
            <div className="px-6 py-8">
              <h1 className="text-center text-zinc-800 text-xl font-semibold mb-6">I Don't Like the Word Product</h1>
              <div className="font-serif text-[15px] leading-7 text-zinc-800 space-y-6">
                <p>Product product product. Talking to you, San Francisco.</p>
                
                <p>How often do you hear Elon use the word product?</p>
                
                <p>I hate the word product. It's not going to help you. Do something else. Live a little.</p>
                
                <p>The word "product" has become a crutch for people who don't know what they're building. It's a placeholder for actual vision, actual purpose, actual meaning.</p>
                
                <p>When you say you're building a "product," what you're really saying is that you're building something that you hope people will buy. You're not saying what it does, why it matters, or how it will change the world.</p>
                ...
                <p>So stop building products. Start building missions. Start building movements. Start building things that matter.</p>
                
                <p>Don't ask yourself what product you're building. Ask yourself what problem you're solving. Ask yourself what world you're trying to create. Ask yourself what legacy you want to leave.</p>
                
                <p>Because in the end, the people who change the world aren't the ones who build the best products. They're the ones who build the best missions.</p>
                
                <p>So do something else. Live a little. Build something that matters.</p>
                
                <p>And stop calling it a product.</p>
              </div>
            </div>
