      ...
      <div className="container mx-auto px-6 pt-28 pb-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Haven's Dual Innovation Ecosystem</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#3B82F6]">
                <h3 className="text-lg font-semibold text-[#3B82F6] mb-3">Digital Experience</h3>
                <p className="text-gray-600 mb-4">Our integrated digital platform delivers cutting-edge content:</p>
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
                  <li>AI-generated films with revolutionary visual quality</li>
                  <li>AI-generated music spanning all genres and moods</li>
                  <li>Proprietary streaming platform for seamless content delivery</li>
                </ul>
              </div>
              
              <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-[#3B82F6]">
                <h3 className="text-lg font-semibold text-[#3B82F6] mb-3">Physical Experience</h3>
                <p className="text-gray-600 mb-4">Our physical spaces create immersive environments:</p>
                <ul className="list-disc pl-5 text-gray-600 space-y-2">
