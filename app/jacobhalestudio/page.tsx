      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-4 pb-20">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-zinc-400">
            ...
            <span className="text-zinc-500">•</span>
            <a href="https://jacobhalestudio.net" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-zinc-100 transition-colors">
              Visit Website
            </a>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              <h3 className="text-lg mb-4 text-zinc-100">Responsive Gallery</h3>
              <p className="text-zinc-400">
            ...
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              <h3 className="text-lg mb-4 text-zinc-100">Image-First Design</h3>
              <p className="text-zinc-400">
            ...
            <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700">
              <h3 className="text-lg mb-4 text-zinc-100">Portfolio Collections</h3>
              <p className="text-zinc-400">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="text-4xl text-zinc-400 font-bold mb-4">01</div>
              <h3 className="text-xl text-zinc-100 mb-2">Discovery</h3>
              <p className="text-zinc-400">
                We analyzed Jacob's photographic style and portfolio needs to design a website that would complement his artistic vision.
              </p>
            </div>
            <div>
              <div className="text-4xl text-zinc-400 font-bold mb-4">02</div>
              <h3 className="text-xl text-zinc-100 mb-2">Design</h3>
              <p className="text-zinc-400">
                Created wireframes and mockups focusing on a minimalist design that would showcase the photography without distraction.
              </p>
            </div>
            <div>
              <div className="text-4xl text-zinc-400 font-bold mb-4">03</div>
            ...
            <div>
              <div className="text-4xl text-zinc-400 font-bold mb-4">04</div>
              <h3 className="text-xl text-zinc-100 mb-2">Launch</h3>
              <p className="text-zinc-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">35%</div>
                <p className="text-zinc-400 text-sm">Increase in session duration</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">40%</div>
                <p className="text-zinc-400 text-sm">More client inquiries</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">90%</div>
                <p className="text-zinc-400 text-sm">Mobile visitors</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-sm border border-zinc-700 text-center">
                <div className="text-3xl font-bold text-zinc-100 mb-2">3s</div>
        ...
        <div className="text-center mt-24">
          ...
          <Link href="/beloved" className="text-xl text-zinc-300 hover:text-zinc-100 transition-colors">
            be-loved.app
