  ...
  return (
    <main className="min-h-screen bg-white text-zinc-700 flex flex-col items-center justify-center p-6 font-sans">
      <div className="container max-w-xl mx-auto py-8 px-4 md:px-8 flex flex-col items-center">
        ...
        >
          <div className="w-96 h-96 mx-auto mb-6 overflow-hidden rounded-md shadow-md">
          ...
          <div className="flex items-center gap-4 mb-6">
            <button 
              ...
              className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-zinc-200 hover:bg-zinc-300 transition-colors duration-300"
